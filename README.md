...
```
cd existing_repo
git remote add origin https://gitlab.com/lakshitha-gw/lucky7-microservices/message-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lakshitha-gw/lucky7-microservices/message-service/-/settings/integrations)
